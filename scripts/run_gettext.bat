...
REM NOCTE-BEGIN nocte-rename
set "pot_file=./localization/i18n/NocteSlicer.pot"
REM NOCTE-END
...
REM NOCTE-BEGIN nocte-rename
set "generated_pot=%generated_i18n%\NocteSlicer.pot"
REM NOCTE-END
set "has_sources=0"
...
:processFile
    ...
    REM NOCTE-BEGIN nocte-rename
    .\tools\msgfmt.exe --check-format -o "./resources/i18n/!lang!/NocteSlicer.mo" "%file%"
    REM NOCTE-END
    if errorlevel 1 (
